...
user1 = User.create!(
  ...
  password: "password",
  name: "henry")
user1.photo.attach(io: File.open((Rails.root.join('db/seeds/images/farms/user1.png'), filename: 'seed-henry.png')

user2 = User.create!(
  email: "test@exemple.com",
  password: "password",
  name: "jonas")
user2.photo.attach(io: File.open((Rails.root.join('db/seeds/images/farms/user2.png'), filename: 'seed-henry.png')


henry = Farm.create!(name: "Famille Henry", user: user1, labels: ['bio'], sells: 19, address: 'Nantes', opening_time: '8h-17h')
henry.photos.attach(io: File.open((Rails.root.join('db/seeds/images/farms/farm3.png')), filename: 'seed-henry.png')


file2 = File.open((Rails.root.join('db/seeds/images/farms/farm1.png'))
...
file3 = URI.open((Rails.root.join('db/seeds/images/farms/farm2.png'))
...
file4 = URI.open((Rails.root.join('db/seeds/images/farms/farm3.png'))
...
file5 = URI.open((Rails.root.join('db/seeds/images/farms/farm1.png'))
